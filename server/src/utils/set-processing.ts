import type { Set, SetStructureValue } from '../types/reference/set.js';
...
export class SetExtractor {
     ...
     */
    static extractSetsFromStructure(structure: SetStructureValue, $: cheerio.CheerioAPI): Set[] {
        const sets: Set[] = [];
...
export class SetLinkFinder {
     ...
     */
    static findSetLinkOnPage(setName: string, $: cheerio.CheerioAPI): string | null {
