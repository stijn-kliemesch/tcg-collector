import type { SetStructure } from '../../types/reference/set';

/**
 * Comprehensive hardcoded structure containing all Pokemon TCG sets
 * This structure serves as the authoritative source for set organization
 * and is used by the SetService to generate structured set data.
 */
export const POKEMON_TCG_SET_STRUCTURE: SetStructure = {
    'International sets': {
        'Generation I': {
            'Original Series': [
                'Base Set',
