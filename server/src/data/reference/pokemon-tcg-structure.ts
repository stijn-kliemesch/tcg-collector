...
export const POKEMON_TCG_SET_STRUCTURE: SetStructure = {
  ...
  'Japanese sets': {
    ...
    'Promotional sets': {
      ...
      'ADV era': ['ADV-P Promotional cards', 'PLAY Promotional cards'],
      'PCG era': [
      ...
      'BW era': ['BW-P Promotional cards', 'Journey Partners'],
      'XY era': ['XY-P Promotional cards'],
      'SM era': ['SM-P Promotional cards', 'Great Detective Pikachu'],
      'S&S era': ['S-P Promotional cards'],
      'SV era': ['SV-P Promotional cards'],
      Miscellaneous: ['Unreleased cards'],
    },
  },
};
