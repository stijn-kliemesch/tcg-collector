...
async function bootstrap() {
  ...
  try {
    ...
    const pokemonTcgExpansion = expansions.find(exp => exp.name === 'Pokémon Trading Card Game')
    ...
    if (pokemonTcgExpansion && pokemonTcgExpansion.link) {
      ...
      console.log('⚠️ Pokemon Trading Card Game expansion not found or missing link - skipping sets bootstrap')
    }
