...
describe('SimpleReferenceDataService', () => {
  it('should be able to read bootstrapped data', () => {
    ...
    if (cacheInfo.exists) {
      console.log(`✅ Found cached data: ${cacheInfo.count} expansions, last updated: ${cacheInfo.lastUpdated}`)
      ...
      const specific = simpleReferenceData.getExpansionByName('Pokémon Trading Card Game')
